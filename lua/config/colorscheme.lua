...
local highlights = {
  -- SyHoMadaraVim Colors
  SyHoMadaraVimPrimary                 = { fg = "#488dff" },
  SyHoMadaraVimSecondary               = { fg = "#FFA630" },
  SyHoMadaraVimPrimaryBold             = { bold = true, fg = "#488DFF" },
  SyHoMadaraVimSecondaryBold           = { bold = true, fg = "#FFA630" },
  SyHoMadaraVimHeader                  = { bold = true, fg = "#488DFF" },
  SyHoMadaraVimHeaderInfo              = { bold = true, fg = "#FFA630" },
  SyHoMadaraVimFooter                  = { bold = true, fg = "#FFA630" },
  SyHoMadaraVimNvimTreeTitle           = { bold = true, fg = "#FFA630", bg = "#16161e" },
  -- Lines
  CursorLineNR                  = { link = "SyHoMadaraVimSecondary" },
  LineNr                        = { link = "Comment" },
  -- Floats/Windows
  ...
  Boolean                       = { fg = "#F7768E" },
  BufferOffset                  = { link = "SyHoMadaraVimSecondary" },
