...
vim.diagnostic.config({
  ...
  virtual_text = (SyHoMadaraVim.diagnostic.virtual_text) and  {
    prefix = SyHoMadaraVim.icons.circle,
  } or false,
})
...
lspui.default_options.border = SyHoMadaraVim.ui.float.border or 'rounded'
