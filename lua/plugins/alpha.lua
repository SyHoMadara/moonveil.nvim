		...
		config = function()
			...
			local function button(sc, txt, keybind, keybind_opts)
				...
				local opts = {
					...
					hl_shortcut = "SyHoMadaraVimPrimary",
				}
				if keybind then
			...
			local function footer()
				...
				local v = vim.version()
				local syhomadaravim_version = line_from(config_dir .. "/.syhomadaravim.version")
