...
return {
  {
    ...
    keys = {
      ...
      { "<leader>lga", function() Snacks.lazygit.log() end,                                    desc = "Lazygit Log (cwd)" },
      { "<leader>llc", function() Snacks.lazygit.log_file() end,                               desc = "Lazygit Current File History" },
      -- ╭─────────────────────────────────────────────────────────╮
      -- │ Zen                                                     │
      -- ╰─────────────────────────────────────────────────────────╯
      ...
      { "<leader>ff",       function() Snacks.picker.smart() end,                                   desc = "smart files" },
      { "<leader>fw",       function() Snacks.picker.grep() end,                                    desc = "grep" },
      { "<leader>fs",  function() Snacks.picker.grep_word() end,                               desc = "grep selected",                   mode = { "n", "v" } },
